...
QPBSF <- q.cl(labPBSF, d.PBSF, "PBSF_cl") +
  capt('Pheasant Branch S.Fork',"Q-C relationship in the South Fork of Pheasant Branch (high chloride contribution to Lake Mendota). The linear regression is represented by the equation y=-6200x+640. The negative correlation (r = -0.84) has an r2 value of 0.7and a p-value of 0.074.")
```
