...
caption = paste("Chloride concentration vs. specific conductivity relationship in the", location, ". The linear regression is represented by the equation y=", s, "x + ", i, "The correlation has an R"~^2~"value of ", r, "and a p-value of ", p, ".", sep = "")
```
