...
# Road_Salt_2019_2020 = (ys$winter1920_salt_outside_MadisonMg + (WINTER_SALT_TOTALS %>% filter(Year == "2019-20"))$Total_Salt_Mg)* 0.60663 #Mg
# Road_Salt_2020_2021 = (ys$winter2021_salt_outside_MadisonMg + (WINTER_SALT_TOTALS %>% filter(Year == "2020-21"))$Total_Salt_Mg)* 0.60663 #Mg
