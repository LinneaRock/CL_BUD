...
Corn_silage <- c(1403.17894, 1329.327417, 1132.390021, 566.1950107, 295.4060926)
...
crops <- crops %>%
  pivot_longer(2:5, names_to = "croptype", values_to = "tonnes") 
...
ggsave("Plots/figsforpres/agsource.png", height = 15, width = 20, units = "cm")
