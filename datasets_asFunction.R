...
loggerYN <- rbind(loggerYN, readSPDST("YN","Data/HOBO_Loggers/YN/Mar16_Jun17/20758343_YN.csv")) %>%
...
loggerYI <- rbind(loggerYI, readSPDST("YI", "Data/HOBO_Loggers/YI/Mar16_Jun17/20758347_YI.csv"))
...
loggerYS <- rbind(loggerYS, readSPDST("YS", "Data/HOBO_Loggers/YS/Mar16_Jun17/20758348_YS.csv"))



loggerSW <- readSP("SW", c("Data/HOBO_Loggers/SW/Dec19_Feb3/20378151_SW.csv", "Data/HOBO_Loggers/SW/Feb3_Mar16/20378151_SW.csv")) 
loggerSW <- rbind(loggerSW, readSPDST("YS", "Data/HOBO_Loggers/SW/Mar16_Jun17/20378151_SW.csv"))
...
logger6MC <- rbind(logger6MC, readSPDST("6MC", "Data/HOBO_Loggers/6MC/Mar16_Jun17/20758342_6MC.csv"))




loggerDC <- readSP("DC", c("Data/HOBO_Loggers/DC/Dec19_Feb4/20758338_DC.csv", "Data/HOBO_Loggers/DC/Feb4_Mar16/20758338_DC.csv")) 
loggerDC <- rbind(loggerDC, readSPDST("DC", "Data/HOBO_Loggers/DC/Mar16_Jun17/20758338_DC.csv"))
...
loggerPBMS <- rbind(loggerPBMS, readSPDST("PBMS", "Data/HOBO_Loggers/PBMS/Mar16_Jun17/20758344_PBMS.csv"))
...
loggerPBSF <- rbind(loggerPBSF, readSPDST("PBSF", "Data/HOBO_Loggers/PBSF/Mar16_Jun17/20758339_PBSF.csv"))
...
x <- readLL("Data/HOBO_Loggers/YS/Feb3_Mar16/WL20484276.csv", "C:/Users/linne/Downloads/pressure_AOS.csv", "Feb3_Mar16")

y <- readLLDST("Data/HOBO_Loggers/YS/Mar16_Jun17/WL20484276.csv", "C:/Users/linne/Downloads/pressure_AOS.csv", "Mar16_Jun17")
